...
namespace VetApp.Controllers
{
    public class ComodidadesController : Controller
    {
        ...
        public ComodidadesController(VeterinariaExtendidaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdComodidad,Nombre,Descripcion,PrecioUnitario")] Comodidade comodidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdComodidad,Nombre,Descripcion,PrecioUnitario")] Comodidade comodidade)
        {
